...
del sys.modules["QuantConnect.DownloaderDataProvider.Launcher"]
from clr import AddReference
AddReference("QuantConnect.DownloaderDataProvider.Launcher")
from QuantConnect.DownloaderDataProvider.Launcher import *
