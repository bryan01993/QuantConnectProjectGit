...
del sys.modules["QuantConnect.DownloaderDataProvider.Launcher.Models"]
from clr import AddReference
AddReference("QuantConnect.DownloaderDataProvider.Launcher.Models")
from QuantConnect.DownloaderDataProvider.Launcher.Models import *
